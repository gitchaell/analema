...
export const LOCATIONS: Location[] = [
	new Location('America/Phoenix', 'UTC-7', 'USA', 'Arizona', 'Fountain Hills', '08:30', '23:30', [
		new Camera('unknown', 'https://www.earthcam.com/usa/arizona/fountainhills/?cam=fountainpark'),
	]),
	new Location('America/Phoenix', 'UTC-7', 'USA', 'Arizona', 'Phoenix', '17:30', '23:30', [
	...
	new Location('America/Phoenix', 'UTC-7', 'USA', 'Arizona', 'Prescott', '17:30', '23:30', [
		new Camera('unknown', 'https://www.earthcam.com/usa/arizona/prescott/?cam=prescott'),
	]),
	new Location('America/Los_Angeles', 'UTC-8', 'USA', 'California', 'Ojai', '08:30', '23:30', [
		new Camera('unknown', 'https://www.earthcam.com/usa/california/ojai/?cam=ojaivalley'),
	]),
	new Location('America/New_York', 'UTC-5', 'USA', 'Florida', 'Englewood Beach', '17:30', '22:30', [
		new Camera('unknown', 'https://www.earthcam.com/usa/florida/portcharlotte/?cam=englewoodbeach'),
	]),
	new Location('America/New_York', 'UTC-5', 'USA', 'Maine', 'Peaks Island', '15:30', '23:30', [
